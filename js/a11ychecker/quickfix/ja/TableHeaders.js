...
( function() {
	...
	CKEDITOR.plugins.a11ychecker.quickFixes.get( { langCode: 'ja',
		...
		callback: function( QuickFix ) {
			...
			TableHeaders.prototype.lang = {"positionLabel":"位置","positionHorizontally":"水平方向","positionVertically":"垂直方向","positionBoth":"両方"};
			CKEDITOR.plugins.a11ychecker.quickFixes.add( 'ja/TableHeaders', TableHeaders );
		}
	} );
}() );
