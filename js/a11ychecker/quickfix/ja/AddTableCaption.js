...
( function() {
	...
	CKEDITOR.plugins.a11ychecker.quickFixes.get( { langCode: 'ja',
		...
		callback: function( QuickFix ) {
			...
			AddTableCaption.prototype.lang = {"captionLabel":"キャプション","errorEmpty":"キャプションテキストは空にできません。"};
			CKEDITOR.plugins.a11ychecker.quickFixes.add( 'ja/AddTableCaption', AddTableCaption );
		}
	} );
}() );
