...
( function() {
	...
	CKEDITOR.plugins.a11ychecker.quickFixes.get( { langCode: 'ja',
		...
		callback: function( ElementReplace ) {
			...
			ParagraphToHeader.prototype.lang = {"levelLabel":"見出しレベル","suggested":"(Suggested)"};
			CKEDITOR.plugins.a11ychecker.quickFixes.add( 'ja/ParagraphToHeader', ParagraphToHeader );
		}
	} );
}() );
