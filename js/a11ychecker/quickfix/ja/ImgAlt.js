...
( function() {
	...
	CKEDITOR.plugins.a11ychecker.quickFixes.get( { langCode: 'ja',
		...
		callback: function( QuickFix ) {
			...
			ImgAlt.prototype.lang = {"altLabel":"代替テキスト","errorTooLong":"代替テキストが長すぎます。現在{length}文字ですが、{limit}文字以下が望ましいです。","errorWhitespace":"代替テキストに空白文字だけを含むことはできません。","errorSameAsFileName":"画像の代替テキストはファイル名と同じにはできません。"};
			CKEDITOR.plugins.a11ychecker.quickFixes.add( 'ja/ImgAlt', ImgAlt );
		}
	} );
}() );
